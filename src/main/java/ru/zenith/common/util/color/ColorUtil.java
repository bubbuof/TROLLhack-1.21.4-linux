...
public class ColorUtil {
    ...
    // GameSense/Skeet.cc style colors
    public int getMainGuiColor() {return new Color(0x0F0F0F).getRGB();}
    public int getGuiRectColor(float alpha) {return multAlpha(new Color(0x1A1A1A).getRGB(),alpha);}
    public int getGuiRectColor2(float alpha) {return multAlpha(new Color(0x252525).getRGB(),alpha);}

    public int getRect(float alpha) {return multAlpha(new Color(0x0F0F0F).getRGB(),alpha);}

    public int getRectDarker(float alpha) {
        return multAlpha(new Color(0x0A0A0A).getRGB(),alpha);
    }

    public int getText(float alpha) {return multAlpha(getText(),alpha);}

    public int getText() {return new Color(0xFFFFFF).getRGB();}
    ...
    public int getOutline() {
        return new Color(0x404040).getRGB();
    }

    // Enhanced GameSense/Skeet.cc style colors
    public int getSkeetAccent() {return new Color(0x8A2BE2).getRGB();} // Brighter purple
    public int getSkeetAccent(float alpha) {return multAlpha(getSkeetAccent(), alpha);}
    public int getSkeetBackground() {return new Color(0x0A0A0A).getRGB();} // Deeper black
    public int getSkeetBackground(float alpha) {return multAlpha(getSkeetBackground(), alpha);}
    public int getSkeetSecondary() {return new Color(0x1C1C1C).getRGB();} // Slightly lighter
    public int getSkeetSecondary(float alpha) {return multAlpha(getSkeetSecondary(), alpha);}
    public int getSkeetBorder() {return new Color(0x3A3A3A).getRGB();} // Softer border
    public int getSkeetBorder(float alpha) {return multAlpha(getSkeetBorder(), alpha);}
    public int getSkeetText() {return new Color(0xFFFFFF).getRGB();}
    public int getSkeetText(float alpha) {return multAlpha(getSkeetText(), alpha);}
    public int getSkeetTextSecondary() {return new Color(0xB8B8B8).getRGB();} // Softer gray
    public int getSkeetTextSecondary(float alpha) {return multAlpha(getSkeetTextSecondary(), alpha);}
    public int getSkeetHover() {return new Color(0x2A2A2A).getRGB();} // Hover state
    public int getSkeetHover(float alpha) {return multAlpha(getSkeetHover(), alpha);}
    public int getSkeetActive() {return new Color(0x8A2BE2).getRGB();} // Active state
    public int getSkeetActive(float alpha) {return multAlpha(getSkeetActive(), alpha);}
}